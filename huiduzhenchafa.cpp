 ...
 /*   if ( gats)
    ...
    if (p > scale) //达到阈值的像素数达到一定的数量则保存该图像
    {
     ...
     // frame.convertTo(frame, frame.type(), alpha, beat);
      ...
      str << "F:/桌面/key/key_" << currentFrame << ".jpg";
      cout << str.str() << endl;
      ...
      if (rotation)
      {
        ...
        {
          str2 << "F:/桌面/key/rotation/key_rotation_" << currentFrame << ".jpg";
      ...
      if (blured)
      {
        ...
        else
        {
          ...
          str3 << "F:/桌面/key/blur/key_blur_" << currentFrame << ".jpg";
      ...
      if (gats)
      {
        ...
        {
          Gats(src, alpha, beat);
          str4 << "F:/桌面/key/gats/key_gats_" << currentFrame << ".jpg";
      ...
      {
        str2.clear();
        str2 << "F:/桌面/key/blend/key_blend_" << currentFrame << ".jpg";
        imwrite(str2.str(), des);
      }
      else
      {
